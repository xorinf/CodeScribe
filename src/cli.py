...
SUPPORTED_LANGUAGES: list[str] = ["python", "javascript", "typescript", "java", "cpp", "csharp", "go", "rust", "ruby", "php", "swift", "kotlin"]
...
def _handle_generate(args: argparse.Namespace) -> None:
    ...
    for lang in SUPPORTED_LANGUAGES:
        if lang != "python":
            universal_exts.extend(_LANGUAGE_EXTENSIONS.get(lang, []))

    registry.register(UniversalParser(universal_exts))
