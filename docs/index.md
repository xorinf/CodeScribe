...
| `src.parser.universal_parser` | `src.parser.base` | BaseParser, ModuleInfo, ClassInfo, FunctionInfo, ParseResult |
| `src.parser` | `src.parser.base` | BaseParser, ModuleInfo, ClassInfo, FunctionInfo, ParseResult |
| `src.parser` | `src.parser.registry` | ParserRegistry |
| `src.parser` | `src.parser.python_parser` | PythonParser |
| `src.parser` | `src.parser.universal_parser` | UniversalParser |
