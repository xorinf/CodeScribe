...
- [test_multi_lang](test_multi_lang.md)
- [test_parser](test_parser.md)
...
| `src.parser.universal_parser` | `src.parser.base` | BaseParser, ParseResult, ModuleInfo, FunctionInfo, ClassInfo, Visibility |
